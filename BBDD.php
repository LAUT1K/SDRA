			...
			<div id="layoutSidenav_content">
				...
				<!-- Cominezo de los formularios -->
					<div class="container px-4">
						<h1 class="mt-2">Gestion de DATABASE</h1>
						<div class="row justify-content-around">
									...
									<div class="card-body">
										<form action="#" method="post">
											...
											<div class="form-group">
												<label for="tecnicatura">Selecciona la tecnicatura:</label>
													<select class="form-select" name="tecnicatura" id="tecnicatura">
														<option value="">Quimica</option>
														<option value="">Maestro Mayor de Obras</option>
														<option value="">Informatica Personal y Profesional</option>
														<option value="">Ciclo Básico</option>
													</select>
											</div>
											<br>
							...
							<div class="col-md-4 col-sm-6 mb-4">
								<div class="card col mb-4 pe-0 ps-0">
									<div class="card-header">
										<i class="fas fa-table me-1"></i>
										CARGA DE ALUMNOS
									</div>
